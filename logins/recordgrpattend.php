...
<div class="sideright">
    ...
    <label style="color:black;margin-right:7px;margin-top:-30px;"><br><?php echo $_SESSION['lectusername']; ?> </label><br><br><br><br><br><br><br><br><br><br>
    <p id="chooseavatar" style="margin-left:50px;font-size:30px;font-family:Open Sans"> Fill in details to record group attendace</p>
    <form action="loggrpattendquery.php" method="POST">
    <div id="fillin">
    <label style="float:left;color:black;margin-top:20px;font-weight:bold;"> Group : </label>
    <input type="text" class="w3-input" id="grpname" name="grpname" class="grpname" style="background:transparent;border-bottom:1px solid grey;margin-top:3px;width:200px;float:left;margin-left:160px;"><br><br><br>
