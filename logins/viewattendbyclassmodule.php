...
<div class="sideright">
    ...
    <label style="font-size:30px;float:left;margin-left:30px;font-weight:bold;color:black"> View Attendance by Class & Module </label>
    <hr style="border:0.3px solid black; float:right;margin-right:30px;width:900px;margin-top:-10px;"><br><br><br>
    
    <label style="font-size:18px;float:left;margin-left:30px;margin-top:-10px;color:black;font-weight:bold;"><u> Attendance by Class </u></label><br><br>
    <div id="table1">
    <?php 
    include_once '../dbConnection.php';     
    $s= "SELECT class, count(class) FROM `recordattend` group by class";
    $result= mysqli_query($conn,$s);
    echo "<table ><tr><th>Class</th><th>Total Class Count</th></tr>";
    ...
    <label style="font-size:18px;float:left;margin-right:200px;margin-top:-430px;color:black;float:right;font-weight:bold;"><u> Attendance by Module </u></label><br><br>
    <div id="table2">
    <?php 
    include_once '../dbConnection.php'; 
    $s= "SELECT module, count(module) FROM `recordattend` group by module";
    $result= mysqli_query($conn,$s);
    echo "<table ><tr><th>Class</th><th>Total Module Count</th></tr>";
    while($row = $result->fetch_assoc()){
        echo "<tr><td >".$row["module"]."</td><td>".$row["count(module)"]."</td></tr>";   
        } 
