...
<div class="sideright">
    ...
    <label style="color:black;"><br><?php echo $_SESSION['studusername']; ?> </label><br><br><br><br><br><br><br><br><br><br>
    <p id="chooseavatar" style="margin-left:50px;font-size:30px;font-family:Open Sans"> Select your option to proceed</p>
        <form action="logstudattend.php"><input type="submit" id="logstudattend" class="logstudattend" value="Log Today's Attendace"><br><br><br></form>
        <form action="viewstudreports.php"><input type="submit" id="viewstudreports" class="viewstudreports" value="View Your Reports"><br><br><br></form>
